	...
	App.view = {
		...
		initPageSlider: function (){
			...
			function route(event) {
				...
				if (hash === "#page1") {
					page = '<div>page1 content<a href="#" class="btn">Back</a></div>';
				//slider.slide($(page), "right");
				} else if (hash === "#page2") {
					page = '<div>page2 content<a href="#" class="btn">Back</a></div>';
				//slider.slide($(page), "right");
				} else if (hash === "#page3") {
					page = '<div>page3 content<a href="#" class="btn">Back</a></div>';
				//slider.slide($(page), "right");
				}
				else {
					page = '<div>' +
